...
{block name=content}
	<section class="u-mb-32">
		...
		<form action="{$BASE_URL}admin/request/create/{$request_user_id}/" method="POST" class="js-radio-check-form">
			...
			{* 登録対象ID *}
			<input type="hidden" name="user_id" value="{$request_user_id}">

...
{block name=content}
	<section class="u-mb-32">
		...
		<form action="{$BASE_URL}admin/user/edit/{$original_id}/" method="POST">
			...
			<div class="form-block__group">
				...
				<div class="form-block__field">
					...
					<div class="form-block__input-wrap">
						<div class="form-block__grant-wrap">
							<div class="form-block__unit-wrap form-block__grant">
								<input
									type="number"
									step="0.5"
									name="holiday_number"
							...
							<p class="form-block__grant-text">次年度付与：{$next_holiday|number_format:1}日</p>
						</div>
				...
				{* 代休残日数 *}
				<div class="form-block__field">
					<label class="form-block__label">代休残日数</label>
					<div class="form-block__input-wrap">
						{$user.compday_number|number_format:1}日
					</div>
				</div>

				{* 特別休暇残日数 *}
				<div class="form-block__field">
					<label class="form-block__label">特別休暇残日数</label>
					<div class="form-block__input-wrap">
						{$user.special_number|number_format:1}日
					</div>
				</div>
			...
			{* 注意 *}
			<p class="error-text u-mt-12">※有休の付与日数に矛盾が生じると整合性が取れなくなるため注意してください</p>
